                                    ...
                                    <div class="content-panel">
                                        <table class="table table-striped table-advance table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="hidden-phone"><i class="fa fa-question-circle"></i> filename
                                                </th>
                                            ...
                                            <c:forEach var="Item" items="${documentList}">
                                                <tr>
                                                    ...
                                                    <td><span
                                                            class="label label-info label-mini">${Item.filename}</span>
                                                    </td>
                                                    <td>${Item.remark}</td>
                                                    ...
                                                    <td>
                                                        <c:if test="${NowUser!=null&&NowUser.status==1}">
                                                            ...
                                                            <button class="btn btn-danger btn-xs">
                                                                <a href="deleteDocument?id=${Item.id}&filename=${Item.filename}"
                                                                   style="color: white;">

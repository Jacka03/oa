        ...
        <section class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 main-chart">
                        ...
                        <form  class="form-inline" role="form"
                            ...
                            <div class="form-group">
                                <label class="sr-only">Email
                                    address</label> <input type="text" class="form-control" placeholder="file Name" name="filename">
                            </div>
                            ...
                            <div class="content-panel">
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th class="hidden-phone"><i class="fa fa-question-circle"></i> filename</th>
                                        <th><i class=" fa fa-edit"></i> remark</th>
                                    ...
                                    <c:forEach var="Item" items="${documentList}">
                                        <tr>
                                            ...
                                            <td><span class="label label-info label-mini">${Item.filename}</span></td>
                                            <td>${Item.remark}</td>
                                            <td>${Item.createDate}</td>
                                            <td>${Item.uploader}</td>
                                            <td>
                                                <button class="btn btn-primary btn-xs">
                                                    <a href="toUpdateDocument?id=${Item.id}"
                                                       style="color: white;">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                </button>
                                                <button class="btn btn-danger btn-xs">
                                                    <a href="deleteDocument?id=${Item.id}"
                                                       style="color: white;">
                    ...
                    <!-- 分页提交的请求表单 -->
                    <form class="search" id="form_query" action="queryDocument">
...
<script type="application/javascript">
    ...
    //删除的操作
    function deleteDocument(id) {//入参跳转的页码
        $.post('deleteDocument', {"id": id}, function (result) {
            if (result == true) {
                alert('删除成功');

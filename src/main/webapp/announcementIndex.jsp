        ...
        <section class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 main-chart">
                        ...
                        <form  class="form-inline" role="form"
                            ...
                            <div class="form-group">
                                <label class="sr-only">Email
                                    address</label> <input type="text" class="form-control" placeholder="title" name="title">
                            </div>
                    ...
                    <!-- 分页提交的请求表单 -->
                    <form class="search" id="form_query" action="queryAnnouncement">
...
<script type="application/javascript">
    ...
    function deleteUser(id) {//入参跳转的页码
        $.post('deleteAnnouncement', {"id": id}, function (result) {
            if (result == true) {
                alert('删除成功');

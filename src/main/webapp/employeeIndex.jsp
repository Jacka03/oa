...
<section id="container">
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <form method="post" action="/oa/insertEmployee" enctype="multipart/form-data">
        <!-- 模态框Modal -->
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>remark：</p>
                        <input type="text" name="remark" value="${employee.remark}"
                               placeholder="请输入remark" autocomplete="off"
                               class="form-control placeholder-no-fix">
                    </div>
                                ...
                                <table class="table table-striped table-advance table-hover">
                                    ...
                                    <c:forEach var="Item" items="${employeeList}">
                                        <tr>
                                            ...
                                            <td>${Item.password}</td>
                                            <td><span class="label label-info label-mini">${Item.username}</span></td>
